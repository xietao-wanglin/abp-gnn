...
class PolyBoundaryWCA(FastSimulation):
    v0: float
    rot_rate: float
    epsilon: float
    sigma: jax.Array
    ...
    def __init__(
        ...
        pair_sigma = (self.sigma[:, None] + self.sigma[None, :]) / 2.0
        
        self.sigma_sq = pair_sigma**2
        self.r_cutoff_sq = ((2 ** (1 / 6)) * pair_sigma) ** 2
