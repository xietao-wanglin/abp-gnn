...
def train(
    ...
    train_particle_type = [np.load(particle_type) for particle_type in particle_type_train_glob]
    test_particle_type = [np.load(particle_type) for particle_type in particle_type_test_glob]
